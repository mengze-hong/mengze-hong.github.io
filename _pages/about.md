...
My research focuses on LLM applications and benchmarking, especially combining their human-level natural language understanding with reliable deterministic generation mechanisms (e.g., retrieval-based systems). If you are interested in any form of academic collaboration, please feel free to reach out via [email](mailto:mengze.hong@connect.polyu.hk).



# 🔥 News
**[2026.01]** 🎉 Three papers were accepted by [TheWebConf 2026](www2026.thewebconf.org) (1 Main + 2 Demos).    
**[2025.09]** 🎉 Three papers were accepted by [EMNLP 2025](https://aclanthology.org/people/mengze-hong/) (2 Main + 1 Industry).    
...
**[2025.04]** 🎉 Two papers were accepted on the topic of [LLM x Music Education](https://link.springer.com/chapter/10.1007/978-3-031-98462-4_19).   
**[2025.02]** 🎉 One paper was accepted by [NAACL 2025 Industry Track](https://aclanthology.org/2025.naacl-industry.71/#).  
**[2024.09]** 🎉 One paper was accepted by [ACML 2024](https://proceedings.mlr.press/v260/hong25a.html).     
...
TheWebConf 2026 (Main). [[link]]() [[code]]()
...
EMNLP 2025 (Main). [[link]](https://aclanthology.org/2025.emnlp-main.303/) [[code]](https://github.com/mengze-hong/QualBench)

**Dial-In LLM: Human-Aligned LLM-in-the-loop Intent Clustering for Customer Service Dialogues**  
**Mengze Hong**, Wailing Ng, Chen Jason Zhang, Yuanfeng Song, Di Jiang  
EMNLP 2025 (Main). [[link]](https://aclanthology.org/2025.emnlp-main.300/) [[code]](https://github.com/mengze-hong/Dial-in-LLM)
...
EMNLP 2025 (Industry). [[link]](https://aclanthology.org/2025.emnlp-industry.51/)
...
- AI and Big Data in Modern Banking Services. (Guest Lecture, PolyU, 2026)    
- Hong Kong’s New Web3 Era: How Stablecoins, RWA, and DeFi are Transforming the Future of Finance. (Seminar, Za Bank & HKU, 2025)    
- LLM-Driven AI Chatbot and Virtual Avatars in Hospitality and Service Sectors. (Guest Lecture, SHTM, 2025)    
